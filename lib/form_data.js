...
FormData.prototype.getAgentProxy = function() {
  var agent;
  var proxy = process.env.PROXY || process.env.HTTPS_PROXY || null;
...
FormData.prototype.getRejectUnauthorized = function() {
...
FormData.prototype.submit = function(params, cb) {
  ...
  options.agent = this.getAgentProxy();
  options.rejectUnauthorized = this.getRejectUnauthorized();
